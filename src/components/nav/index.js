...
export function NavBar(props) {
  ...
  return (
    <Menu theme="dark" mode={mode}>
      ...
      <SubMenu key="configuracion" icon={<ControlOutlined />} title="Configuracion">
        <Menu.ItemGroup title="Configuraciones">
        <Menu.Item key="clientes" icon={<UsergroupAddOutlined />}>
        <Link to={"/clientes"}>Clientes</Link>
        </Menu.Item>
          <Menu.Item key="vehiculos" icon={<CarOutlined />}><Link to={"/vehiculos"}>Vehiculos</Link></Menu.Item>
          <Menu.Item key="servicios"  icon={<CarOutlined />}><Link to={"/servicios"}>Servicios</Link></Menu.Item>
          <Menu.Item key="repuestos" icon={<SettingOutlined />}><Link to={"/repuestos"}>Repuestos</Link></Menu.Item>
        </Menu.ItemGroup>
      </SubMenu>
      <SubMenu key="seguridad" icon={<KeyOutlined />} title="Seguridad">
        <Menu.ItemGroup title="sub-seguridad">
          <Menu.Item key="users" icon={<TeamOutlined />}><Link to={"/usuarios"}>Usuarios</Link></Menu.Item>
